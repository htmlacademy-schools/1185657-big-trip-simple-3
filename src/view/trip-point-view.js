...
export default class TripPointView extends AbstractView {
  ...
  updateTripPoint(updatedTripPoint) {
    ...
    this.element.querySelector('.event__date').datetime = `${getDateForDateTimeWithoutTime(this.#tripPoint.dateFrom)}`;
    this.element.querySelector('.event__date').textContent = `${humanizePointDueDate(this.#tripPoint.dateFrom)}`;
    this.element.querySelector('.event__start-time').datetime = `${this.#tripPoint.dateFrom}`;
    this.element.querySelector('.event__start-time').textContent = `${getTimeForDateWithoutDate(this.#tripPoint.dateFrom)}`;
    this.element.querySelector('.event__end-time').datetime = `${this.#tripPoint.dateTo}`;
    this.element.querySelector('.event__end-time').textContent = `${getTimeForDateWithoutDate(this.#tripPoint.dateTo)}`;
