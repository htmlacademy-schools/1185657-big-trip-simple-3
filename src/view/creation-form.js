...
import { getRandomPic } from '../utils.js';
import { humanizePointEditorDueDate } from '../utils.js';

const createCreationFormTemplate = (tripPoint) => {
  ...
  for (let i = 0; i < destination.pictures.length; i++) {
    htmlImages += `
    <img class="event__photo" src="${getRandomPic()}" alt="Event photo">`;
  }
      ...
      <div class="event__type-wrapper">
        ...
        <div class="event__type-list">
          <fieldset class="event__type-group">
            ...
            <div class="event__type-item">
              <input id="event-type-sightseeing-1" class="event__type-input  visually-hidden" type="radio" name="event-type" value="sightseeing" ${type === 'sighseeing' ? 'checked' : ''}'>
...
export default class CreationFormElement {
  constructor(tripPoint) {
    this.tripPoint = tripPoint;
  }

  getTemplate(tripPoint) {
    return createCreationFormTemplate(tripPoint);
  }
