import NoPointViewPresenter from './presenter/no-point-view-presenter';
...
const serverTripPoints = new TripPointApiService('https://18.ecmascript.pages.academy/big-trip', 'Basic wrkjlsfoi3453459a');
